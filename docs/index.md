...
- 🔎 Search technical resources: [Pashto Resource Search](search/)
- 📄 Search papers: [Pashto Papers Search](papers/)
- 📘 Browse docs: [Documentation Hub](README.md)
- 📦 Browse verified catalog guide: [resource_catalog.md](resource_catalog.md)
